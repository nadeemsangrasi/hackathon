...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (generateBtn) {
        generateBtn.addEventListener("click", () => {
              ...
              <div>
                ...
                document.querySelectorAll(".editBtn").forEach((btn) => {
                    btn.addEventListener("click", (e) => {
                        ...
                        const para = parentDiv === null || parentDiv === void 0 ? void 0 : parentDiv.querySelector(".para");
                        const input = parentDiv === null || parentDiv === void 0 ? void 0 : parentDiv.querySelector(".editable");
                        const doneBtn = parentDiv === null || parentDiv === void 0 ? void 0 : parentDiv.querySelector(".doneBtn");
                ...
                document.querySelectorAll(".doneBtn").forEach((btn) => {
                    btn.addEventListener("click", (e) => {
                        ...
                        const input = parentDiv === null || parentDiv === void 0 ? void 0 : parentDiv.querySelector(".editable");
                        const doneBtn = parentDiv === null || parentDiv === void 0 ? void 0 : parentDiv.querySelector(".doneBtn");
                        const editBtn = parentDiv === null || parentDiv === void 0 ? void 0 : parentDiv.querySelector(".editBtn");
                        if (input && para && doneBtn) {
          ...
          <div class="shareable-url no-print">
